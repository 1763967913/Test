...
function ss_mendt(){
	...
	document.getElementById("ss_women").src="../pc/rw_22.gif";
	document.getElementById("ss_men").src="../pc/rw_1.gif";
...
function ss_womendt(){
	...
	document.getElementById("ss_men").src="../pc/rw_11.gif";
	document.getElementById("ss_women").src="../pc/rw_2.gif";
...
function deletebutton(){
	...
	document.getElementById("shiyi_"+i).src="../pc/tm.gif";
